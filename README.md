...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/compas_rrc-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12427&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/compas_rrc-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `compas_rrc` can be installed with:

```
conda install compas_rrc
```

It is possible to list all of the versions of `compas_rrc` available on your platform with:
